...
use crate::codec::{TimeBase as Rational, mask::BinaryMaskVideoMuxer};
...
use crate::{
    codec::{
        TransparentVideoMuxer, probe_av, read_gray8_png, read_rgba_png, write_gray8_png,
        write_rgba_png,
    },
...
fn validate_staged_video_outputs_inner(
    ...
    let mut foreground = if let Some(path) = foreground_path {
        ...
        crate::codec::decode::validate_qtrle(path)?;
